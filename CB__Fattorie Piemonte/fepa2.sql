...
Declare @sAna_grpCod varchar(16)
...
Left Join dbo.[MixAna] ANA 
On 1 = ANA.ItemType And DOC.AnaCod = ANA.ItemID
...
If @sDOC_AnaCod = '00704' OR @sAna_grpCod = 'CON' -- Personalizzazioni per Esselunga e Conad
Begin
	If Len(@sDsmCod) > 0
	Begin
		Select
...
Begin
	-- INIZIO PERS
	If @sDOC_AnaCod = '00704' OR @sAna_grpCod = 'CON' -- Esselunga 
	Begin
...
BEGIN
	...
	Begin
		...
		If @sDOC_AnaCod <> '00704' AND @sAna_grpCod <> 'CON'-- Non-Esselunga
			Insert [#TAGs](TagText) Values('<CodiceValore>' + @sPrdCod + '</CodiceValore>')
		Else
